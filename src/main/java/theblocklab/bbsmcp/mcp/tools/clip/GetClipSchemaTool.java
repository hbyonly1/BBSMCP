...
public class GetClipSchemaTool extends MCPTool {
    ...
    private static final String INTERP_ENUM =
            "linear | constant | step | hermite | bezier | cubic | " +
    ...
    public GetClipSchemaTool() {
        super("get_clip_schema", "Query available clip types, their fields, and interpolation constants. Call before add_clip if unsure about the schema.");
    }
